...
public class Actividad4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.pantalla4);
        ...
        botonEntrar2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Ahora vamos la otra actividad
                Intent intent = new Intent(Actividad4.this, Actividad2.class);
                startActivity(intent);
            }
        });
        // Ahora escuchamos el click del botón
        ...
        botonEntrar4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Ahora vamos la otra actividad
                Intent intent = new Intent(Actividad4.this, Actividad4.class);
                startActivity(intent);
            }
        });
        // Ahora escuchamos el click del botón
